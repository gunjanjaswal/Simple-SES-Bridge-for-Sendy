...
*   **🎨 Responsive Layouts**: Choose from 3 mobile-friendly designs:
    *   **Simple List**: Clean and classic.
    *   **Grid**: Modern 2-column layout (stacks on mobile).
    *   **Full Content**: For deep-dive newsletters.
